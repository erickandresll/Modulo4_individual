...
class Vendedor(Usuario):
    def __init__(self, id_vendedor, nombre, correo, departamento=None):
...
except AttributeError: #por si la función no está disponible, ejemplo devolver producto.
    print("Esta función no está disponible.")
except (IndexError, TypeError, KeyError, NameError) as e: #ocupo e para guardar el error y entregarlo en el print.
    print("Se produjo un error de índice, tipo, clave o dato: ", e)
finally:
    print("Ha salido del programa.")

#Utilizo los mismos errores para vendedor.
vendedor1 = None
try:
...
La principal es que evita que el programa se detenga inesperadamente. Además,
facilita la identificación del error. Por último, podría entregar una mejor 
experiencia al usuario, no entregandole mensajes confusos. 
